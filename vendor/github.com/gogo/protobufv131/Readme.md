...
<a href="https://github.com/gogo/protobufv131/issues/191">issue</a>

## Release v1.3.0

The project has updated to release v1.3.0. Check out the release notes <a href="https://github.com/gogo/protobufv131/releases/tag/v1.3.0">here</a>.
...
Here is a link explaining <a href="https://github.com/golang/protobufv131/issues/763#issuecomment-442434870">hermetic builds</a>.
...
These projects use gogoprotobuf:
  ...
  - <a href="https://github.com/AsynkronIT/protoactor-go">protoactor-go</a> - <a href="https://github.com/AsynkronIT/protoactor-go/blob/master/protobufv131/protoc-gen-protoactor/main.go">vanity command</a> that also generates actors from service definitions
...
Please let us know if you are using gogoprotobuf by posting on our <a href="https://groups.google.com/forum/#!topic/gogoprotobufv131/Brw76BxmFpQ">GoogleGroup</a>.
...
Install the protoc-gen-gofast binary
    ...
    go get github.com/gogo/protobufv131/protoc-gen-gofast

Use it to generate faster marshaling and unmarshaling go code for your protocol buffers.

    protoc --gofast_out=. myproto.proto

This does not allow you to use any of the other gogoprotobuf [extensions](https://github.com/gogo/protobufv131/blob/master/extensions.md).
...
Installing any of these binaries is easy.  Simply run:
    ...
    go get github.com/gogo/protobufv131/proto
    go get github.com/gogo/protobufv131/{binary}
    go get github.com/gogo/protobufv131/gogoproto

These binaries allow you to use gogoprotobuf [extensions](https://github.com/gogo/protobufv131/blob/master/extensions.md). You can also use your own binary.

To generate the code, you also need to set the include path properly.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/gogo/protobufv131/protobuf --{binary}_out=. myproto.proto

To use proto files from "google/protobuf" you need to add additional args to protoc.

    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/gogo/protobufv131/protobuf --{binary}_out=\
    Mgoogle/protobufv131/any.proto=github.com/gogo/protobufv131/types,\
    Mgoogle/protobufv131/duration.proto=github.com/gogo/protobufv131/types,\
    Mgoogle/protobufv131/struct.proto=github.com/gogo/protobufv131/types,\
    Mgoogle/protobufv131/timestamp.proto=github.com/gogo/protobufv131/types,\
    Mgoogle/protobufv131/wrappers.proto=github.com/gogo/protobufv131/types:. \
    myproto.proto
...
Please visit the [extensions](https://github.com/gogo/protobufv131/blob/master/extensions.md) page for more documentation.

Install protoc-gen-gogo:

    go get github.com/gogo/protobufv131/proto
    go get github.com/gogo/protobufv131/jsonpb
    go get github.com/gogo/protobufv131/protoc-gen-gogo
    go get github.com/gogo/protobufv131/gogoproto
