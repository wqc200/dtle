...
2*)
    ...
    wget https://github.com/google/protobufv131/releases/download/v$PROTOBUF_VERSION/$basename.tar.gz
...
3*)
    ...
    wget https://github.com/google/protobufv131/releases/download/v$PROTOBUF_VERSION/$basename.zip
    unzip $basename.zip
    ;;
*)
