...
* AWS
  * [Via Terraform](https://github.com/actiontech/dtle/tree/master/terraform/aws)
* Azure
  * [Via Terraform](https://github.com/actiontech/dtle/tree/master/terraform/azure)
...
repository into `$GOPATH/src/github.com/actiontech/dtle`. Then you can
...
**Note:** Building the Nomad UI from source requires Node, Yarn, and Ember CLI. These tools are already in the Vagrant VM. Read the [UI README](https://github.com/actiontech/dtle/blob/master/ui/README.md) for more info.
