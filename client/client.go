...
import (
	...
	"github.com/actiontech/dtle/helper/pool"
	hstats "github.com/actiontech/dtle/helper/stats"
	"github.com/actiontech/dtle/helper/tlsutil"
	"github.com/actiontech/dtle/helper/uuid"
	"github.com/actiontech/dtle/nomad/structs"
	nconfig "github.com/actiontech/dtle/nomad/structs/config"
...
func NewClient(cfg *config.Config, consulCatalog consul.CatalogAPI, consulService consulApi.ConsulServiceAPI) (*Client, error) {
	...
	if err := c.restoreState(); err != nil {
		...
		logger.Error("Corrupt state is often caused by a bug. Please " +
			...
			"https://github.com/actiontech/kafkas/issues")
...
//
// See:
//  * https://github.com/actiontech/dtle/pull/6207
//  * https://github.com/actiontech/dtle/issues/5984
//
// COMPAT(0.12): remove once upgrading from 0.9.5 is no longer supported
