...
import (
	...
	dtle "github.com/actiontech/dtle/dtle-nomad"
...
func transDtleArgsToNomadArgs(args dtle.Job) (nomadargs api.JobRegisterRequest) {
	nomadargs.Region = *args.Region
	nomadargs.Job.Region = args.Region
	nomadargs.EnforceIndex = args.EnforceIndex
	nomadargs.JobModifyIndex = *args.ModifyIndex
	nomadargs.Job.ID = args.ID
	nomadargs.Job.ModifyIndex = args.ModifyIndex
	nomadargs.Job.JobModifyIndex = args.JobModifyIndex
	//nomadargs.Job.Version
	nomadargs.Job.Type = args.Type
	nomadargs.Job.StatusDescription = args.StatusDescription
	nomadargs.Job.Name = args.Name
	// nomadargs.Job.Affinities
	//	nomadargs.Job.AllAtOnce = args.
	nomadargs.Job.CreateIndex = args.CreateIndex
	nomadargs.Job.Datacenters = args.Datacenters
	for num, task := range args.Tasks {
...
func (s *HTTPServer) jobUpdate(resp http.ResponseWriter, req *http.Request,
	...
	var dtleArgs dtle.Job
	if err := decodeBody(req, &dtleArgs); err != nil {
		return nil, CodedError(400, err.Error())
	}
	args := transDtleArgsToNomadArgs(dtleArgs)
