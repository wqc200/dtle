...
import (
	...
	ucli "github.com/actiontech/dtle/olddtle/internal/client"
	uconf "github.com/actiontech/dtle/olddtle/internal/config"
	umodel "github.com/actiontech/dtle/olddtle/internal/models"
	usrv "github.com/actiontech/dtle/olddtle/internal/server"
...
func (a *Agent) clientConfig() (*uconf.ClientConfig, error) {
	...
	conf.Node.NatsAddr = a.config.normalizedAddrs.Nats
	conf.Node.NatsAdvertiseAddr = a.config.AdvertiseAddrs.Nats
